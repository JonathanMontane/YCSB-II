...
{     
	...
	public ZipfianGenerator(String _items)
	{
		this(0,Long.parseLong(_items)-1);
	}

	public ZipfianGenerator(String min, String max)
	{
		this(Long.parseLong(min), Long.parseLong(max), ZIPFIAN_CONSTANT);
	}
	
	public ZipfianGenerator(String min, String max, String _zipfianconstant)
	{
		this(
			Long.parseLong(min),
			Long.parseLong(max),
			Double.parseDouble(_zipfianconstant),
			zetastatic(Long.parseLong(max)-Long.parseLong(min)+1,Double.parseDouble(_zipfianconstant))
		);
	}

	public ZipfianGenerator(String min, String max, String _zipfianconstant, String _zetan)
	{
